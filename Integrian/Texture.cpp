...
Integrian::Texture::Texture(const std::string& text, const std::string& fontPath, int ptSize, const RGBColour& textColor)
	: m_Id{}
	, m_Width{ 10.0f }
	, m_Height{ 10.0f }
	, m_CreationOk{ false }
...
Integrian::Texture::Texture(Texture&& other) noexcept
	: m_Id{ other.m_Id }
...
Integrian::Texture& Integrian::Texture::operator=(Texture&& other) noexcept
{
...
Integrian::Texture::~Texture()  // NOLINT(modernize-use-equals-default)
{
	glDeleteTextures(1, &m_Id);
}

void Integrian::Texture::CreateFromImage(const std::string& path)
{
	m_CreationOk = true;
...
void Integrian::Texture::CreateFromString(const std::string& text, const std::string& fontPath, int ptSize, const RGBColour& textColor)
{
	m_CreationOk = true;
...
void Integrian::Texture::CreateFromSurface(SDL_Surface* pSurface)
{
	m_CreationOk = true;
...
void Integrian::Texture::Draw(const Rectf& dstRect, const Rectf& srcRect) const
{
	const float epsilon{ 0.001f };
	if (!m_CreationOk)
	{
...
float Integrian::Texture::GetWidth() const
{
	return m_Width;
}

float Integrian::Texture::GetHeight() const
{
	return m_Height;
}

bool Integrian::Texture::IsCreationOk() const
{
	return m_CreationOk;
}

void Integrian::Texture::DrawFilledRect(const Rectf& rect) const
{
